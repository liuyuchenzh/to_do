...
.controller("listController", ["gevent", "convertDate", "setDisabled",
  "removeListOnStorage", "listData", "$scope",
  function (gevent, convertDate, setDisabled, removeListOnStorage, listData, $scope) {
	var that = this;
  ...
  this.sortList = function() {
    ...
    sortList(method, undefined, listData.lists);
  }
  ...
  this.setAorD = function() {
    ...
    sortList(undefined, aOrD, listData.lists);
  }
...
.controller("trashCanController", ["gevent", "removeListOnStorage", "listData",
  "$scope",
  function(gevent, removeListOnStorage, listData, $scope) {
  var that = this;
  ...
  this.selectAll = function() {
    (function(tLists){
      ...
      var list;
      var checked = that.state.all;
      for (var i = 0, len = tLists.length; i < len; i++) {
        list = tLists[i];
